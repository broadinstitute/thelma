...
func (_m *Environment) AutoDelete() terra.AutoDelete {
	...
	if len(ret) == 0 {
		panic("no return value specified for AutoDelete")
	}
...
func (_m *Environment) BaseDomain() string {
	...
	if len(ret) == 0 {
		panic("no return value specified for BaseDomain")
	}
...
func (_m *Environment) DefaultCluster() terra.Cluster {
	...
	if len(ret) == 0 {
		panic("no return value specified for DefaultCluster")
	}
...
func (_m *Environment) IsCluster() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for IsCluster")
	}
...
func (_m *Environment) IsEnvironment() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for IsEnvironment")
	}
...
func (_m *Environment) NamePrefixesDomain() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for NamePrefixesDomain")
	}
...
func (_m *Environment) Offline() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for Offline")
	}
...
func (_m *Environment) OfflineScheduleBeginEnabled() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for OfflineScheduleBeginEnabled")
	}
...
func (_m *Environment) OfflineScheduleBeginTime() time.Time {
	...
	if len(ret) == 0 {
		panic("no return value specified for OfflineScheduleBeginTime")
	}
...
func (_m *Environment) OfflineScheduleEndEnabled() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for OfflineScheduleEndEnabled")
	}
...
func (_m *Environment) OfflineScheduleEndTime() time.Time {
	...
	if len(ret) == 0 {
		panic("no return value specified for OfflineScheduleEndTime")
	}
...
func (_m *Environment) OfflineScheduleEndWeekends() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for OfflineScheduleEndWeekends")
	}
...
func (_m *Environment) PreventDeletion() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for PreventDeletion")
	}
...
func (_m *Environment) ReleaseType() terra.ReleaseType {
	...
	if len(ret) == 0 {
		panic("no return value specified for ReleaseType")
	}
...
func (_m *Environment) RequireSuitable() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for RequireSuitable")
	}
...
func (_m *Environment) TerraHelmfileRef() string {
	...
	if len(ret) == 0 {
		panic("no return value specified for TerraHelmfileRef")
	}
...
func (_m *Environment) UniqueResourcePrefix() string {
	...
	if len(ret) == 0 {
		panic("no return value specified for UniqueResourcePrefix")
	}
