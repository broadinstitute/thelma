...
func (_m *AppRelease) AppVersion() string {
	...
	if len(ret) == 0 {
		panic("no return value specified for AppVersion")
	}
...
func (_m *AppRelease) ChartName() string {
	...
	if len(ret) == 0 {
		panic("no return value specified for ChartName")
	}
...
func (_m *AppRelease) ChartVersion() string {
	...
	if len(ret) == 0 {
		panic("no return value specified for ChartVersion")
	}
...
func (_m *AppRelease) ClusterAddress() string {
	...
	if len(ret) == 0 {
		panic("no return value specified for ClusterAddress")
	}
...
func (_m *AppRelease) FirecloudDevelopRef() string {
	...
	if len(ret) == 0 {
		panic("no return value specified for FirecloudDevelopRef")
	}
...
func (_m *AppRelease) HelmfileOverlays() []string {
	...
	if len(ret) == 0 {
		panic("no return value specified for HelmfileOverlays")
	}
...
func (_m *AppRelease) IsAppRelease() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for IsAppRelease")
	}
...
func (_m *AppRelease) IsClusterRelease() bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for IsClusterRelease")
	}
...
func NewAppRelease(t interface {
	mock.TestingT
	Cleanup(func())
}) *AppRelease {
	mock := &AppRelease{}
