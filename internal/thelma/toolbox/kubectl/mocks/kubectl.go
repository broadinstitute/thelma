...
func (_c *Kubectl_CreateNamespace_Call) RunAndReturn(run func(terra.Environment) error) *Kubectl_CreateNamespace_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *Kubectl_DeleteNamespace_Call) RunAndReturn(run func(terra.Environment) error) *Kubectl_DeleteNamespace_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *Kubectl_DeletePVCs_Call) RunAndReturn(run func(terra.Environment) error) *Kubectl_DeletePVCs_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *Kubectl_Exec_Call) RunAndReturn(run func(kubecfg.Kubectx, kubectl.Container, []string, ...shell.RunOption) error) *Kubectl_Exec_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Kubectl) ExecInteractive(ktx kubecfg.Kubectx, container kubectl.Container, command []string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for ExecInteractive")
	}
...
func (_c *Kubectl_ExecInteractive_Call) RunAndReturn(run func(kubecfg.Kubectx, kubectl.Container, []string) error) *Kubectl_ExecInteractive_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Kubectl) PortForward(targetRelease terra.Release, targetResource string, targetPort int) (int, func() error, error) {
	...
	var r1 func() error
	var r2 error
	if rf, ok := ret.Get(0).(func(terra.Release, string, int) (int, func() error, error)); ok {
		return rf(targetRelease, targetResource, targetPort)
	}
