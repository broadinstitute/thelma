...
func (_m *Chart) BumpChartVersion(latestPublishedVersion string) (string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for BumpChartVersion")
	}
...
func (_m *Chart) GenerateDocs() error {
	...
	if len(ret) == 0 {
		panic("no return value specified for GenerateDocs")
	}
...
func (_m *Chart) LocalDependencies() []string {
	...
	if len(ret) == 0 {
		panic("no return value specified for LocalDependencies")
	}
...
func (_m *Chart) ManifestVersion() string {
	...
	if len(ret) == 0 {
		panic("no return value specified for ManifestVersion")
	}
...
func (_m *Chart) PackageChart(destPath string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for PackageChart")
	}
...
func (_m *Chart) SetDependencyVersion(dependencyName string, newVersion string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for SetDependencyVersion")
	}
