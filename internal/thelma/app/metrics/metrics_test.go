...
thelma_basic_counter{thelma_platform="jenkins",thelma_version="unset"} 42`,
		},
		{
...
thelma_basic_gauge{foo="bar",thelma_platform="jenkins",thelma_version="unset"} 100`,
		},
		{
			name: "inherit labels",
			record: func(m Metrics) {
...
thelma_inherit_counter{a="1",b="43",baz="quux",c="3",thelma_platform="jenkins",thelma_version="unset"} 24
# HELP thelma_inherit_gauge 
# TYPE thelma_inherit_gauge gauge
thelma_inherit_gauge{a="1",b="2",c="3",thelma_platform="jenkins",thelma_version="unset"} -100`,
		},
		{
			name: "mutate metrics",
			record: func(m Metrics) {
...
thelma_incremented_counter{thelma_platform="jenkins",thelma_version="unset"} 3
# HELP thelma_updated_gauge 
# TYPE thelma_updated_gauge gauge
thelma_updated_gauge{thelma_platform="jenkins",thelma_version="unset"} 0.3`,
		},
		{
...
thelma_counter{_job="fixme",a="1",b="2",thelma_platform="jenkins",thelma_version="unset"} 123
`,
		},
		{
...
thelma_fake_task_count{id="23",ok="false",thelma_platform="jenkins",thelma_version="unset"} 1
thelma_fake_task_count{id="23",ok="true",thelma_platform="jenkins",thelma_version="unset"} 1
# HELP thelma_fake_task_duration_seconds A fake task
# TYPE thelma_fake_task_duration_seconds gauge
thelma_fake_task_duration_seconds{id="23",ok="false",thelma_platform="jenkins",thelma_version="unset"} 1.8
thelma_fake_task_duration_seconds{id="23",ok="true",thelma_platform="jenkins",thelma_version="unset"} 1.2
`,
		},
	}
