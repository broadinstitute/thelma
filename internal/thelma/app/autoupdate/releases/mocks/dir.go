...
func (_m *Dir) CleanupOldReleases(keepReleases int) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for CleanupOldReleases")
	}
...
func (_m *Dir) CopyUnpackedArchive(unpackDir string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for CopyUnpackedArchive")
	}
...
func (_m *Dir) CurrentVersionMatches(version string) bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for CurrentVersionMatches")
	}
...
func (_m *Dir) UpdateCurrentReleaseSymlink(version string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateCurrentReleaseSymlink")
	}
...
func (_m *Dir) WithInstallerLock(fn func() error) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for WithInstallerLock")
	}
